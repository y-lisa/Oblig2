    ...
    public static void main(String[] args) {
        ...
        int forekomst = 0;
         ...
         // Setter inn HashMap-ene
            HashMap<String, Subsekvens> flettet = monitor2.flett();

            // for each-lokke
            for (Map.Entry<String, Subsekvens> entry : flettet.entrySet()) {
                String frekventSubsekvens = entry.getKey();
                Subsekvens s = entry.getValue();

                // Sjekker for hver subsekvens om antallet er mer enn 0, som så økes for hver runde
